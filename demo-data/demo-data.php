<?php
function creative_import_files() {
    return [
        [
            'import_file_name'             => 'Creative theme demo data import',
            'categories'                   => 'Category',
            ...
            'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'creative' ),
        ],
    ];
}
add_filter( 'pt-ocdi/import_files', 'creative_import_files' );

function creative_after_import() {
...
add_filter( 'pt-ocdi/after_import', 'creative_after_import' );